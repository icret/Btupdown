...
if($config['manager'] === false)
{
	header('location:'.$config['domain'].'?undefined');
}
...
function fm_get_translations($tr) {
    try {
        $content = @file_get_contents('static/translation.json');
        if($content !== FALSE) {
...
<!-- ZUI Javascript组件 -->
<script src="static/zui/js/zui.min.js?v=1.9.1"></script>
</body>
</html>
<?php
}
...
<head>
    ...
    <link href="static/ekko-lightbox.css" rel="stylesheet">
    <?php if (FM_USE_HIGHLIGHTJS): ?>
    <link rel="stylesheet" href="static/vs.min.css">
    <?php endif; ?>
    <style>
        body {
            font-size: 14px;
...
<script src="static/zui/jquery.min.js"></script>
<script src="static/bootstrap.min.js"></script>
...
<script>
    ...
    //TFM Config
    window.curi = "static/config.json", window.config = null;
